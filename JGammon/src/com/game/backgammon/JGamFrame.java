...
public class JGamFrame extends JFrame {
    ...
    private ImageIcon turnIcon = new ImageIcon(JGamFrame.class.getResource("/com/game/backgammon/img/turn.gif"));
    private ImageIcon flipIcon = new ImageIcon(JGamFrame.class.getResource("/com/game/backgammon/img/flip.gif"));
    private ImageIcon newMsgIcon = new ImageIcon(JGamFrame.class.getResource("/com/game/backgammon/img/newmsg.gif"));
    private ImageIcon newMsgDisabledIcon = new ImageIcon(JGamFrame.class.getResource("/com/game/backgammon/img/newMsgDisabled.gif"));
